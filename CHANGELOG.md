...
* add currency conversion library with unit tests ([b2eb41c](https://github.com/raid-guild/nexus-crm/commit/b2eb41cdea7381c3aa513b785ef22a4410b8de90))
* add CurrencyProvider context and header CurrencySwitcher ([4851c56](https://github.com/raid-guild/nexus-crm/commit/4851c562ee47116890bd414448ee2ecfa55f0b7f))
* add Docker entrypoint script for auto-initialization ([1acba0a](https://github.com/raid-guild/nexus-crm/commit/1acba0a5311dc99181075e61da92d59b099aff1c))
* add docker-compose.yml with all services ([c045ebb](https://github.com/raid-guild/nexus-crm/commit/c045ebbfb0d07c25fa3e5c09c44b4ace7467b067))
* add full legacy crm preview ([7c308e0](https://github.com/raid-guild/nexus-crm/commit/7c308e06107a684ef94c5faeda3232fae7330e07))
* add lead segments for mcp outreach ([372ba49](https://github.com/raid-guild/nexus-crm/commit/372ba4951f03c32f2442f95c004888122b4cdcfb))
* add memory archive crm preview ([b73ec26](https://github.com/raid-guild/nexus-crm/commit/b73ec26604baa4e7e660376e0eebf7ef264bd12c))
* add multi-stage Dockerfile for NextCRM ([70a1b45](https://github.com/raid-guild/nexus-crm/commit/70a1b45937af818df1a6b1c99f7d774f49af2796))
* add portal launch handoff auth ([fea8330](https://github.com/raid-guild/nexus-crm/commit/fea8330817b214eff7f172846040114caeba6f56))
* add prism document handoff ([52816ac](https://github.com/raid-guild/nexus-crm/commit/52816ac99250b58db552eeaf3ceccf9f675e29ff))
* add SKILL.md download to Developer tab ([b1f528d](https://github.com/raid-guild/nexus-crm/commit/b1f528d03b26ca4332f4d673c60cf51a8f303cab))
* add SKILL.md for Claude Code MCP integration ([b3a57b8](https://github.com/raid-guild/nexus-crm/commit/b3a57b870403285efb883fafd1a4306db19fc5c2))
* **admin:** add currencies management page with table, rates, and ECB toggle ([6011159](https://github.com/raid-guild/nexus-crm/commit/60111591311e525f2d5857f73ce40cd9e7aca231))
* align activity actions with deletedAt soft delete ([95de688](https://github.com/raid-guild/nexus-crm/commit/95de688b97f712271e4ae771423aaadea627d104))
* align board/project actions with deletedAt soft delete ([df3fe1e](https://github.com/raid-guild/nexus-crm/commit/df3fe1eb1a222cec130c1abd92918cfdbcc76c09))
* align campaign template actions with deletedAt soft delete ([a95ac24](https://github.com/raid-guild/nexus-crm/commit/a95ac246e784cb3748a676126beefbd6b7e20d37))
* align crm-data and target-list actions with deletedAt soft delete ([eaa6a15](https://github.com/raid-guild/nexus-crm/commit/eaa6a15ab8d76867100bb28bc84892180e583434))
* align nexus branding for railway ([d78ce20](https://github.com/raid-guild/nexus-crm/commit/d78ce200ce293e6f8878dbf9f59955d83cde0f2c))
* align target actions with deletedAt soft delete ([bbdad13](https://github.com/raid-guild/nexus-crm/commit/bbdad13defcf45a9756cf055ea977cf156d66fab))
* **authz:** add account read-scope helpers ([6fdff66](https://github.com/raid-guild/nexus-crm/commit/6fdff669fdd1db42789b106e0e4f8939a98f6ff0))
* **authz:** add account write-scope assertion helper ([fb4b8f6](https://github.com/raid-guild/nexus-crm/commit/fb4b8f66052d62097bea9c66c1d0c8bf9ae4c05c))
* **authz:** add account/lead/opportunity id-filter helpers (similarity post-filter) ([98b32f1](https://github.com/raid-guild/nexus-crm/commit/98b32f17eb2c11e9237f95eddc85d0bf89d8206b))
* **authz:** add activity-for-entity scope dispatch helper ([db08f51](https://github.com/raid-guild/nexus-crm/commit/db08f51b8b943ffac1a755029a27c352e6ac7a6f))
* **authz:** add AuthenticationError and AuthorizationError ([47e4980](https://github.com/raid-guild/nexus-crm/commit/47e49805928975b8a0932c380871c0e174c287c1))
* **authz:** add barrel export ([48a2a5e](https://github.com/raid-guild/nexus-crm/commit/48a2a5e379f8a634ebd322603c139c2cf715a399))
* **authz:** add board and task read/write scope helpers ([380e6a5](https://github.com/raid-guild/nexus-crm/commit/380e6a59f636416ef1650ef849b947b6edab7a4a))
* **authz:** add bulk-id authorization filters for contacts and targets ([388d29d](https://github.com/raid-guild/nexus-crm/commit/388d29dcbea52c6dfcfe2e3720ed2bb3fc515cb7))
* **authz:** add campaign and template read/write scope helpers ([6af7af0](https://github.com/raid-guild/nexus-crm/commit/6af7af033f6d49df1844fb07e2687401d110c7c0))
* **authz:** add canonical AppRole type and legacy role mapper ([1350ed3](https://github.com/raid-guild/nexus-crm/commit/1350ed39623a61aa31ed2e9220fa66b7782796a4))
* **authz:** add document read/write scope helpers (linked-entity aware) ([f2122a2](https://github.com/raid-guild/nexus-crm/commit/f2122a23eec404e431445d7645ef9c3431e5bdce))
* **authz:** add enrichment cancel permission helpers ([6acbfec](https://github.com/raid-guild/nexus-crm/commit/6acbfec765d0bc68748a20f8b3df75602220bd5c))
* **authz:** add lead/contact/opportunity/contract read-scope helpers (linked-account aware) ([bfaef87](https://github.com/raid-guild/nexus-crm/commit/bfaef8756686eb2c07236b1250e67032cbaafbb4))
* **authz:** add read/write assertion helpers for contacts and targets ([e0fff6b](https://github.com/raid-guild/nexus-crm/commit/e0fff6b911f145fe1878de9d3969657b897bb2f9))
* **authz:** add ReportScope builder for per-role report data filtering ([0035bf0](https://github.com/raid-guild/nexus-crm/commit/0035bf0cb3047a5a54c7caf7eb898b2037306d79))
* **authz:** add requireAuthenticated, requireRole, role predicates ([30c3472](https://github.com/raid-guild/nexus-crm/commit/30c3472f94e6e2555ad2ca9109f793c795b7c497))
* **authz:** add route response helpers (401/403/404) ([7ad29ae](https://github.com/raid-guild/nexus-crm/commit/7ad29aea1639d3c403d1283698c65c74aef164ed))
* **authz:** add scoped contact and target update helpers ([071cb2c](https://github.com/raid-guild/nexus-crm/commit/071cb2ceab48858c505a3ed7e3b0ae47119e7b1e))
* **authz:** add target and target-list read-scope helpers ([45b82a8](https://github.com/raid-guild/nexus-crm/commit/45b82a87538d54921cbb370b9d873cb42cc68a35))
* **authz:** align UI/action callers to canonical role names ([1dc5618](https://github.com/raid-guild/nexus-crm/commit/1dc5618c6c17d3e5b96295c9c38ff2324fd91447))
* **authz:** switch Users.role to Prisma enum AppRole ([d598305](https://github.com/raid-guild/nexus-crm/commit/d598305ebc97b15852f41d5cc5f1807836302cfe))
* **authz:** validate setUserRole against canonical AppRole ([77241b7](https://github.com/raid-guild/nexus-crm/commit/77241b726b748a5191c5acb6c331888672eac947))
* **contracts:** add currency and snapshot rate to create/update actions ([1a6a4c8](https://github.com/raid-guild/nexus-crm/commit/1a6a4c8010f7561985e2b865c20bae5d77e81082))
* **contracts:** add currency dropdown to create/update forms ([f0e961d](https://github.com/raid-guild/nexus-crm/commit/f0e961d184c98acb39b4edb2d598e2e78ea651d7))
* **contracts:** display contract value with dynamic currency formatting ([d2c7308](https://github.com/raid-guild/nexus-crm/commit/d2c7308d76ae70d6f5838bf33474d2bfb1f59b38))
* convert opportunity detail budget to display currency ([aa82933](https://github.com/raid-guild/nexus-crm/commit/aa82933d27d3b5a960232c679f98fe451947786a))
* convert opportunity table budget to display currency ([030ca11](https://github.com/raid-guild/nexus-crm/commit/030ca11feb1427455d33d1143b8ab1bf7cbb1e36))
* convert reports dashboard KPIs to display currency ([a564588](https://github.com/raid-guild/nexus-crm/commit/a5645887b2f4ec14ee4db19a62bde43c25a85295))
* **crm:** add assign/disconnect document server actions for CRM tasks ([26f234a](https://github.com/raid-guild/nexus-crm/commit/26f234a4837014b6ce8d8d3ae2f128367a7ec6c2))
* **crm:** show invoices on account detail page ([a207314](https://github.com/raid-guild/nexus-crm/commit/a207314aded4b706b6fca9b537a603cbb55a9972))
* **crm:** show invoices on account detail page ([5f0f4e9](https://github.com/raid-guild/nexus-crm/commit/5f0f4e98314cd4bb4efe60e2c7d9967bc09f7d5f))
* **dashboard:** add Invoices, Campaigns, Targets cards; remove Employee card ([df13534](https://github.com/raid-guild/nexus-crm/commit/df1353496e128f0f6c7035a28391e9ec8c786b76))
* **dashboard:** display expected revenue in selected display currency ([7a2fa8f](https://github.com/raid-guild/nexus-crm/commit/7a2fa8fece3fc5a10b35eabc1ebcf5b4dce2a9ff))
* **db:** backfill canonical roles (admin/manager/user) and sync is_admin ([f7475f5](https://github.com/raid-guild/nexus-crm/commit/f7475f5d081a1cba0ae76c9af962c10f5209648b))
* Docker self-hosting setup with full automation ([bff363e](https://github.com/raid-guild/nexus-crm/commit/bff363e646f0bfa55178922f4af05234515a0920))
* **documents:** add batch actions bar for bulk delete, type change, and account linking ([7ed7cfa](https://github.com/raid-guild/nexus-crm/commit/7ed7cfa0ef97bd7281605a390a7b212fc3aa1324))
* **documents:** add bulk actions, versioning, and account linking server actions ([6a8908a](https://github.com/raid-guild/nexus-crm/commit/6a8908a39580f20e99e232fc03f944d381b1265f))
* **documents:** add document detail panel with summary, metadata, and version history ([9fd00f1](https://github.com/raid-guild/nexus-crm/commit/9fd00f1a0785e7715aaf4e4e6c70457e7256efee))
* **documents:** add enrichment fields, chunks table, and embeddings model ([c58a1e6](https://github.com/raid-guild/nexus-crm/commit/c58a1e657b23795504cdc9708682ab6e5d69178c))
* **documents:** add Inngest enrichment orchestrator with text extraction, embedding, summary, classification ([a7216cb](https://github.com/raid-guild/nexus-crm/commit/a7216cbb1a0a5370096560a5a513ec0e732b1743))
* **documents:** add name/content search toggle on documents page ([8043818](https://github.com/raid-guild/nexus-crm/commit/8043818bc1c2756ceb4cf7d3dd19f0fabe8de461))
* **documents:** add processing status badge component ([514fa69](https://github.com/raid-guild/nexus-crm/commit/514fa6963c9c4c7946bd4f08ac4d634110f68dc2))
* **documents:** add thumbnail generator and register Inngest functions ([b0b406e](https://github.com/raid-guild/nexus-crm/commit/b0b406ea4be6e75d865b0f85f1f21ccb5a693365))
* **documents:** add upload-from-account-context with auto-linking ([cb3a096](https://github.com/raid-guild/nexus-crm/commit/cb3a0963573e6ca5d38e4bb2d731b639dce09ee0))
* **documents:** redesign columns with type badges, summaries, status, and filters ([9ecd298](https://github.com/raid-guild/nexus-crm/commit/9ecd2984127f91fdcbe50616a5ae21afcf8eb64d))
* **documents:** replace 3 upload buttons with single bulk upload modal ([dde3a47](https://github.com/raid-guild/nexus-crm/commit/dde3a477e01ded54ba52953ed80da2baa8099e4e))
* **documents:** update createDocument with Inngest event, add checkDuplicate action ([90c2bbc](https://github.com/raid-guild/nexus-crm/commit/90c2bbc3021ba54eb3133a89fe6df9c9c8ecdfef))
* **documents:** update Zod schema and static filter data for enrichment fields ([4ce71b3](https://github.com/raid-guild/nexus-crm/commit/4ce71b37a63ab09999ba4d7283a8d1a4850fb6bc))
* enable Next.js standalone output for Docker ([d8d1056](https://github.com/raid-guild/nexus-crm/commit/d8d10565fb0fbb425f5d9bb2a41c3fe06a24cf83))
* expand mcp lead intake workflow ([730d575](https://github.com/raid-guild/nexus-crm/commit/730d57543eac194558424fe7ae6d99fdb142f7c5))
* expose lead statuses over mcp ([f025285](https://github.com/raid-guild/nexus-crm/commit/f02528513734bdb64db4dfa5f5663a067a2b439e))
* **footer:** read app version from package.json ([0052e17](https://github.com/raid-guild/nexus-crm/commit/0052e17aadf5283299da88bc695c4b4124fa48fd))
* **footer:** read app version from package.json instead of env var ([003a728](https://github.com/raid-guild/nexus-crm/commit/003a728b56429230d40058622e7d0f6fb925e150))
* group memory archive crm history ([4d8910a](https://github.com/raid-guild/nexus-crm/commit/4d8910a759af9ed523bfa183465d88ded53986de))
* **inngest:** add daily ECB exchange rate sync function ([61e0819](https://github.com/raid-guild/nexus-crm/commit/61e08199f0bf783f7ebbb5230e298b8feafb0c56))
* **invoices:** add FKs, indexes, line-item trigger, money CHECK ([1496266](https://github.com/raid-guild/nexus-crm/commit/1496266419db40292f2b0829eacafbc2c9457c4d))
* **invoices:** add numbering format template + counter consumer ([e533aeb](https://github.com/raid-guild/nexus-crm/commit/e533aeb4e7bbe55c1b5a4a5e77c8a6872ef2bc6f))
* **invoices:** add PDF i18n string bundles (EN/CZ) ([02bcd7d](https://github.com/raid-guild/nexus-crm/commit/02bcd7d04f3ffda004f8b2297038314ea0564dbd))
* **invoices:** add permission guards ([cb12109](https://github.com/raid-guild/nexus-crm/commit/cb121093ed0f49895fa079a8158ed02ba74810ef))
* **invoices:** add Prisma schema, migration, tsvector trigger ([6b9f7f3](https://github.com/raid-guild/nexus-crm/commit/6b9f7f366e8592a07d0ac534d0cc6b216762379c))
* **invoices:** add search filter builder ([a37c5fb](https://github.com/raid-guild/nexus-crm/commit/a37c5fb894101a9f1d30ab91651f3ece0707d109))
* **invoices:** add totals computation with mixed VAT support ([cced002](https://github.com/raid-guild/nexus-crm/commit/cced002054d70f3b6ccb26d6fca20d31bcf70584))
* **invoices:** admin pages — tax rates, series, currencies, settings ([9ed05dc](https://github.com/raid-guild/nexus-crm/commit/9ed05dc5f6518784e72f697e5ef0595d04eea5b9))
* **invoices:** API routes for invoices CRUD, lifecycle, payments, search, admin config ([dcd47d0](https://github.com/raid-guild/nexus-crm/commit/dcd47d09b367006c3fd467d817b7ef98969cc68c))
* **invoices:** fetch FX rates via frankfurter.app ([04c4e0e](https://github.com/raid-guild/nexus-crm/commit/04c4e0e208aba5eb5ad849736357fbca4223f708))
* **invoices:** full invoicing module ([2b420ff](https://github.com/raid-guild/nexus-crm/commit/2b420ff085211e321572a55e02a400662380fbc7))
* **invoices:** invoice email template ([788252b](https://github.com/raid-guild/nexus-crm/commit/788252b5f3e31692f90a965f4132c1147619d8db))
* **invoices:** invoice UI — list, new, detail, edit pages ([40a09a6](https://github.com/raid-guild/nexus-crm/commit/40a09a6e3e62da41d9b01bca8cbfab1bf687c4df))
* **invoices:** MinIO storage wrapper for invoice PDFs ([028d4c2](https://github.com/raid-guild/nexus-crm/commit/028d4c2ed35b1cc0a945d317263cf76f82d18bc2))
* **invoices:** PDF render entry ([b9112c4](https://github.com/raid-guild/nexus-crm/commit/b9112c426ad86b810d28a62a1faf723c4b7271ce))
* **invoices:** PDF template (@react-pdf/renderer) ([11109f6](https://github.com/raid-guild/nexus-crm/commit/11109f62c5fdc5754446862b1beffb285a476127))
* **invoices:** seed currencies, default series, tax rates, settings ([68a8b80](https://github.com/raid-guild/nexus-crm/commit/68a8b80793a5f989bd5ea031522e8e467d7459c0))
* **invoices:** server actions for invoice lifecycle ([e698e71](https://github.com/raid-guild/nexus-crm/commit/e698e716141f4dcd0d48e2bea7a0bb9ec7217e7e))
* **invoices:** sidebar nav entry + i18n (EN/CZ) ([8c5f1d6](https://github.com/raid-guild/nexus-crm/commit/8c5f1d609961e870b5823990695f75edbcd6a839))
* **invoices:** Zod schemas + shared types ([103b2c8](https://github.com/raid-guild/nexus-crm/commit/103b2c81517ae23eed2e01f7361c0b1d8acc7273))
* **line-items:** add line items section to Contract detail page with copy-from-opportunity ([e3235fe](https://github.com/raid-guild/nexus-crm/commit/e3235fe0f8c4c1e468ed239668dcb1d60a46a1ac))
* **line-items:** add line items section to Opportunity detail page ([24436e1](https://github.com/raid-guild/nexus-crm/commit/24436e17a3d043ac1cefed2269cb6bebcf008323))
* **line-items:** add Prisma schema for Opportunity and Contract line items ([f3b1f30](https://github.com/raid-guild/nexus-crm/commit/f3b1f301e464760780dea6402192e71cbfb90de8))
* **line-items:** add server actions for Contract line items with copy-from-opportunity ([baa83d1](https://github.com/raid-guild/nexus-crm/commit/baa83d1b2bcc8401dd895f54c98402727ad8568b))
* **line-items:** add server actions for Opportunity line items ([680fa93](https://github.com/raid-guild/nexus-crm/commit/680fa93ef4d2631b7f71d035804f954966b629a9))
* **line-items:** add shared calculation helper ([825c733](https://github.com/raid-guild/nexus-crm/commit/825c7339302d995094ef595722f5c4f0718e6383))
* **line-items:** add shared LineItemsTable, AddLineItemForm, and EditLineItemForm components ([e839227](https://github.com/raid-guild/nexus-crm/commit/e839227a731660b4c1bd32d9c6206f6ac03c6543))
* MCP full parity (104 tools) + universal deletedAt soft-delete ([a164dcb](https://github.com/raid-guild/nexus-crm/commit/a164dcb458a99a423a30357111c2068136973dc1))
* **mcp:** accounts delete uses deletedAt instead of status ([f565523](https://github.com/raid-guild/nexus-crm/commit/f5655230775e703c0390811c0f9e7a4b77c2af25))
* **mcp:** add activities tools (5 tools, with entity links) ([7298d63](https://github.com/raid-guild/nexus-crm/commit/7298d632b1ed1f87e32a911b216bbbae60f93425))
* **mcp:** add barrel export and update route handler with new error codes ([bec7bbd](https://github.com/raid-guild/nexus-crm/commit/bec7bbd4a3eb832795c0485df508a1c88085cb4b))
* **mcp:** add campaigns tools (19 tools, full lifecycle + templates + steps + stats) ([7155053](https://github.com/raid-guild/nexus-crm/commit/7155053f44598eb5db45b5f4460a370578ee2bf7))
* **mcp:** add contracts tools (5 tools, with line items) ([79c3013](https://github.com/raid-guild/nexus-crm/commit/79c301311e0c1873941bb40d4af231aeec56e19a))
* **mcp:** add documents tools (8 tools, presigned URLs, entity linking) ([756d2be](https://github.com/raid-guild/nexus-crm/commit/756d2bea8630cbd1196df6e14884139fe22fa465))
* **mcp:** add enrichment tools (4 tools, single + bulk for contacts and targets) ([2067f21](https://github.com/raid-guild/nexus-crm/commit/2067f21ba57c61594cffa0ace229e3843a8bf9c4))
* **mcp:** add products tools (5 tools, org-wide catalog) ([7038bf2](https://github.com/raid-guild/nexus-crm/commit/7038bf2dac23b7a12ad23cc0213f2aeb49ba56f1))
* **mcp:** add projects tools (18 tools, boards/sections/tasks/comments/watchers) ([b40f3ae](https://github.com/raid-guild/nexus-crm/commit/b40f3ae572c61ad62de8b8c2ce0477535f2c6849))
* **mcp:** add reports tools (2) and email accounts tool (1) ([efe9cc7](https://github.com/raid-guild/nexus-crm/commit/efe9cc719ac15ed1f3d99f8496eee9e5bb39adf4))
* **mcp:** add shared helpers for pagination, search, soft-delete, errors ([a8a0eb0](https://github.com/raid-guild/nexus-crm/commit/a8a0eb0dd40375242c167c4f1a7f398286cfd683))
* **mcp:** add target lists tools (7 tools, membership management) ([4cdd748](https://github.com/raid-guild/nexus-crm/commit/4cdd748582733be4f63f7382a6717cfb70a0cf62))
* **mcp:** campaigns use deletedAt instead of status for soft-delete ([0fac95e](https://github.com/raid-guild/nexus-crm/commit/0fac95e803ff1bcd07a22e0af68e1da4ad76b8bd))
* **mcp:** documents use deletedAt instead of status for soft-delete ([440c629](https://github.com/raid-guild/nexus-crm/commit/440c629f31a4af548640fd18ba66fc36ea9b2eb3))
* **mcp:** enable board soft-delete, add deletedAt filters to board queries ([8973d34](https://github.com/raid-guild/nexus-crm/commit/8973d343ef5bc2bd7828f36b90fcf65f8cd2fabe))
* **mcp:** enable opportunities soft-delete, add deletedAt filters ([3805ab2](https://github.com/raid-guild/nexus-crm/commit/3805ab298afb1f0c14848af12c503025ce472ad5))
* **mcp:** enable soft-delete for contacts, leads, targets, activities ([75217e4](https://github.com/raid-guild/nexus-crm/commit/75217e431146a4a6871f17445a67c178c0e01405))
* **mcp:** rename account tools with crm_ prefix, add soft-delete, use helpers ([288204b](https://github.com/raid-guild/nexus-crm/commit/288204bf7e870a7cc2b560c3994f7823ad311eb2))
* **mcp:** rename contacts/leads/opportunities/targets with crm_ prefix, add delete stubs ([24bfdcd](https://github.com/raid-guild/nexus-crm/commit/24bfdcd7bbebdb164a25305438f566557995bb9e))
* **mcp:** target lists use deletedAt instead of boolean status ([1e917ed](https://github.com/raid-guild/nexus-crm/commit/1e917edf1ba029648bee72cd9aa9c81aba907450))
* **mcp:** update helpers to use deletedAt-based soft delete ([41433ce](https://github.com/raid-guild/nexus-crm/commit/41433ce7d26ac6b2ae6a31b7865b3da9007539db))
* **migration:** add currency support migration ([86b7663](https://github.com/raid-guild/nexus-crm/commit/86b76636742c8bc4860de078f3731ac0e36886f9))
* multi-currency support for Sales module ([19848b0](https://github.com/raid-guild/nexus-crm/commit/19848b0b050cf7f76e1694cc1a608c1f7a558eb2))
* **opportunities:** add currency dropdown to create/update forms ([49cb1b7](https://github.com/raid-guild/nexus-crm/commit/49cb1b78e2595ee86651fe5ab6c0471856034d50))
* **opportunities:** add snapshot rate lookup on create/update ([f0f8380](https://github.com/raid-guild/nexus-crm/commit/f0f8380a2cc72cac4ede8304a737129ec4f93313))
* **opportunities:** display budget and revenue with currency formatting ([664c096](https://github.com/raid-guild/nexus-crm/commit/664c09645f9f161499e1e3486afda7b6700eeced))
* prepare nexus crm railway deployment ([2780ff1](https://github.com/raid-guild/nexus-crm/commit/2780ff1346fd9112762483e959950cb88ff86473))
* Products module, Line Items, and E2E test coverage ([cdb4498](https://github.com/raid-guild/nexus-crm/commit/cdb4498460b2081c8609370a79e19ae7e9d4f6fc))
* **products:** add create and update product form components ([98c4e60](https://github.com/raid-guild/nexus-crm/commit/98c4e60128ce5c983e48056197d6c69615d4ad56))
* **products:** add CSV bulk import server action ([3ed188a](https://github.com/raid-guild/nexus-crm/commit/3ed188aee12bc9d9b98b00b1c0481a0acb569888))
* **products:** add CSV import dialog with preview and template download ([c9b7388](https://github.com/raid-guild/nexus-crm/commit/c9b7388e0319c425716489a28a4a71bb1638a6dc))
* **products:** add Prisma schema for Products, ProductCategories, AccountProducts ([2c51b70](https://github.com/raid-guild/nexus-crm/commit/2c51b70350dcede4e3ef2ec4e64993477916f79c))
* **products:** add product categories to CRM data fetching ([eba0ea6](https://github.com/raid-guild/nexus-crm/commit/eba0ea653b3872c1288b8c1c40f83f7198e18d74))
* **products:** add product detail page with basic view, accounts tab, and history ([53d0d1f](https://github.com/raid-guild/nexus-crm/commit/53d0d1f3fb6be30b08b5487e8c5996e74893dbc6))
* **products:** add products list page and view component ([9b33aa7](https://github.com/raid-guild/nexus-crm/commit/9b33aa7440a4f7acb3a5eaba6d47f38b66d0a0fd))
* **products:** add server actions for Account-Product assignments ([ea3bc87](https://github.com/raid-guild/nexus-crm/commit/ea3bc8746f4fa3bd3225ed47818d345a8f8e4d4c))
* **products:** add server actions for Product CRUD and data fetching ([e84ea83](https://github.com/raid-guild/nexus-crm/commit/e84ea835663c59cef8021b86f3fd3afb9b64655b))
* **products:** add sidebar nav, account detail products tab with assign form ([3c1ab8b](https://github.com/raid-guild/nexus-crm/commit/3c1ab8b1ceec1616362676b1cf6de7968d5aeb22))
* **products:** add table components with columns, filters, and row actions ([7fe5c4c](https://github.com/raid-guild/nexus-crm/commit/7fe5c4ce5e1dfbfe196a55d2245e473952162ee4))
* **reports:** convert sales report values to display currency ([3784f7d](https://github.com/raid-guild/nexus-crm/commit/3784f7df9df29567cfe4a443f2fc9fdfefadd1d2))
* **reports:** per-category functions accept ReportScope to filter data by role ([87d73e0](https://github.com/raid-guild/nexus-crm/commit/87d73e0c982b11c259bbdeef298641e087fd4251))
* **schema:** add Currency, ExchangeRate, SystemSettings models and migrate money fields to Decimal ([bf3f16d](https://github.com/raid-guild/nexus-crm/commit/bf3f16d29532af16e8cd9dae46bb2d570fa6d0fd))
* **search:** add document search to command palette ([a0a5bbe](https://github.com/raid-guild/nexus-crm/commit/a0a5bbe064b358933f33fa8ad1b43c039c64659d))
* **search:** add documents to unified search with keyword + vector similarity ([299736f](https://github.com/raid-guild/nexus-crm/commit/299736fd74c539b65472db021cc8cfe0f1335abd))
* **security:** permission-driven authorization migration (Phases A → F.1) ([e06478f](https://github.com/raid-guild/nexus-crm/commit/e06478ff16f9a7472c6d16cd0ef6e96c5c409446))
* **seed:** add currency and exchange rate seed data ([3da4975](https://github.com/raid-guild/nexus-crm/commit/3da4975b75029a1b7134c875e8f6656849cd73df))
* split document ai provider ([466a9c4](https://github.com/raid-guild/nexus-crm/commit/466a9c4d58b9e5bc5457e1a496056c2a3b9a8814))
* support sendgrid otp email ([aad5826](https://github.com/raid-guild/nexus-crm/commit/aad58262c6a84659707a5ef88c3f5e135a68ed24))


### Bug Fixes

* **account-products:** require account read scope on get-account-products ([36f2d0d](https://github.com/raid-guild/nexus-crm/commit/36f2d0d073adcab04729e15395d1f1b1d0273890))
* **account-products:** require account write scope on assignment mutations ([dfa1850](https://github.com/raid-guild/nexus-crm/commit/dfa18506a9d96eacb31c7014ca39d17cf46c1c56))
* add currency field to contracts table schema ([ed6a675](https://github.com/raid-guild/nexus-crm/commit/ed6a675648110d30aaf57920d9439c0f4c3f88fb))
* add currency to Opportunity schema type and fix implicit any ([a7ab752](https://github.com/raid-guild/nexus-crm/commit/a7ab752aa9c5879ee13600e7565852e0d251f2c6))
* add explicit types to currency map callbacks ([7d4d5a4](https://github.com/raid-guild/nexus-crm/commit/7d4d5a4912b285c7f84974fd08fadef3855c3aa1))
* add explicit types to currency map callbacks in layout ([33e74f4](https://github.com/raid-guild/nexus-crm/commit/33e74f44d2bf16a28a880986803e1247034e294d))
* add line items migration and resolve migration drift ([1b6f483](https://github.com/raid-guild/nexus-crm/commit/1b6f48392cf3801551ed918fd7b379aefe6b4513))
* address prism integration review feedback ([7ab2a5d](https://github.com/raid-guild/nexus-crm/commit/7ab2a5d5c0d213d6b6d1426937c3d191085ea994))
* **admin:** require admin role on activate/deactivate user (close audit gap) ([8215af2](https://github.com/raid-guild/nexus-crm/commit/8215af27d86575b3a094e554dbe4e401810fc5e4))
* **admin:** require admin role on CRM-settings server actions ([be27db7](https://github.com/raid-guild/nexus-crm/commit/be27db7b31c6e65796bed7d73d1ba8433173a561))
* **admin:** require admin role on currency server actions ([8dfc9ad](https://github.com/raid-guild/nexus-crm/commit/8dfc9ad99c3c5224675f9d11046f014a98c1115c))
* allow null description in opportunities table schema ([662e6bd](https://github.com/raid-guild/nexus-crm/commit/662e6bd7992537a3f7c31e708f1b89d1d4399e96))
* allow null description in opportunities table schema ([8b414ac](https://github.com/raid-guild/nexus-crm/commit/8b414acbe81bc327ffa7ff6a23fbc21436b817b0))
* allow opportunities without close dates ([e0ee3fb](https://github.com/raid-guild/nexus-crm/commit/e0ee3fbfbb6c2ed3aa9582f159566e1a8b4c0c45))
* allow short lead names in table ([e42c847](https://github.com/raid-guild/nexus-crm/commit/e42c8472b78abe623be53ddce0b0a940bc89beb2))
* **api:** filter contact bulk enrichment ids by user scope ([5014d9a](https://github.com/raid-guild/nexus-crm/commit/5014d9ad747c75e0278950a361e30073d09c7c17))
* **api:** filter target bulk enrichment ids by user scope ([4af94fe](https://github.com/raid-guild/nexus-crm/commit/4af94fe910f9eb3b0290fe519eae0e7efde1a72e))
* **api:** require contact write scope on enrich POST/DELETE ([b1530c0](https://github.com/raid-guild/nexus-crm/commit/b1530c091ebc15e255ccce47e220b755bae8db17))
* **api:** require invoice read scope on PDF route ([a35d7d0](https://github.com/raid-guild/nexus-crm/commit/a35d7d0c0c7d12a58b4567bb3fa62fe1dc324508))
* **api:** require parent target write scope on target-contact create ([28912b4](https://github.com/raid-guild/nexus-crm/commit/28912b43aed27a08243c066ed644d57c195fe817))
* **api:** require target write scope and contact linkage on per-target-contact enrich ([80f9ee4](https://github.com/raid-guild/nexus-crm/commit/80f9ee4dadaff611cbd4fc578e2d7048e371ca76))
* **api:** require target write scope on enrich POST/DELETE (auto-fixes campaign re-export) ([18a0b56](https://github.com/raid-guild/nexus-crm/commit/18a0b562a14b36f3b6137a18a856fb8f616f3414))
* **api:** require target write scope on per-target enrich (auto-fixes campaign re-export) ([85cfe72](https://github.com/raid-guild/nexus-crm/commit/85cfe720fb2281eb73d74ec737d3c7037442b37f))
* **api:** scope reports/export by role; gate users-directory report ([571fbf3](https://github.com/raid-guild/nexus-crm/commit/571fbf37caf71a7a2f66980cf28c6e1a710141e7))
* **api:** scoped contact PATCH closes BOLA/IDOR (GHSA-mg5f-m89f-4gmc) ([c80d3ec](https://github.com/raid-guild/nexus-crm/commit/c80d3ec564ddb5f3bf38aec54ff5fb5aa3e7e90c))
* **api:** scoped target PATCH closes BOLA/IDOR (auto-fixes campaign re-export) ([cd0ed0a](https://github.com/raid-guild/nexus-crm/commit/cd0ed0a4139398cf003505c44e9bc8a91a9def76))
* **auth:** align auth-client roles with renamed manager/user ([66e0e84](https://github.com/raid-guild/nexus-crm/commit/66e0e8428556c9c75da28f601ef33d38cf94a674))
* **auth:** resolve Google OAuth user creation failures ([844389a](https://github.com/raid-guild/nexus-crm/commit/844389a689c0f20ab8d75bdf10648beeb829c5e3))
* **auth:** resolve Google OAuth user creation failures ([094e7ee](https://github.com/raid-guild/nexus-crm/commit/094e7ee715c034b7c023a574241871690cee68ad))
* **authz:** drop readonly tuple from accountUserScopeOR for Prisma compat ([39bcebe](https://github.com/raid-guild/nexus-crm/commit/39bcebe70acfe17a391b1d0ad06178c7752b0a43))
* **authz:** include deletedAt:null in target read scope (crm_Targets has soft-delete) ([7a8fc2e](https://github.com/raid-guild/nexus-crm/commit/7a8fc2e620c11e3abd9c3b1456703eced05eb61d))
* **authz:** replace is_admin checks with requireRole on admin invoice routes ([a54ed98](https://github.com/raid-guild/nexus-crm/commit/a54ed9836deb11b7ba8714fc15a0248d36824ab3))
* **authz:** use lowercase prismadb.documents accessor ([a816361](https://github.com/raid-guild/nexus-crm/commit/a816361a0029165294d1e201423a10fdc4e570d8))
* **build:** resolve failed migration before deploy ([d063791](https://github.com/raid-guild/nexus-crm/commit/d0637914f2f296e079afd3fd280be204540c8b60))
* **campaign-templates:** scope template reads/mutations by role and ownership ([417ae5a](https://github.com/raid-guild/nexus-crm/commit/417ae5a8e7ad6049397af2a03997d27b81cc2bfe))
* **campaigns:** narrow createCampaign result before using campaign.id ([1794a88](https://github.com/raid-guild/nexus-crm/commit/1794a88ebde37b491a532865229c78175e5f65f4))
* **campaigns:** require auth + ownership on create/update/delete/pause ([6f2b02e](https://github.com/raid-guild/nexus-crm/commit/6f2b02e1b35823c87a5a9d6a15e751bc90064c23))
* **campaigns:** require manager/admin role on schedule and send-now ([7361442](https://github.com/raid-guild/nexus-crm/commit/7361442c5226030125ede66cb45ba6ea5c4a9aab))
* **campaigns:** scope campaign reads by role ([146d5b4](https://github.com/raid-guild/nexus-crm/commit/146d5b4b224bd887dacb50e69b954ea7bdbb8795))
* close pg pool on seed completion ([8193219](https://github.com/raid-guild/nexus-crm/commit/81932196b5988495e329313b01c2f2e8a50b3ca6))
* **crm-settings:** allow creating industry, opportunity type, and sales stage values ([dc111f0](https://github.com/raid-guild/nexus-crm/commit/dc111f03541e3724e1483e832f39dbc0411b58fd))
* **crm:** expand getCrMTask document select and clean up junction on delete ([b6d2f6b](https://github.com/raid-guild/nexus-crm/commit/b6d2f6b4197999af116ae2165d80c7feb4cefd42))
* **crm:** remove task-specific filters from document table toolbar ([5cca3d1](https://github.com/raid-guild/nexus-crm/commit/5cca3d1e4e25caef5b6b09056575495ec77c9a64))
* **crm:** require account read scope on getAccountById ([edb9b9b](https://github.com/raid-guild/nexus-crm/commit/edb9b9b821b10cc5271560b73caf8efaba02c59c))
* **crm:** require entity-scoped read access on activity feed ([568a7cc](https://github.com/raid-guild/nexus-crm/commit/568a7cc8c56e0eb10f97442bb43ea3206978a4d6))
* **crm:** scope account list by user/manager/admin role ([a9f9a6f](https://github.com/raid-guild/nexus-crm/commit/a9f9a6fa3755e561678361d91af6bae8e239fa2e))
* **crm:** scope account search by user/manager/admin role ([3fd6673](https://github.com/raid-guild/nexus-crm/commit/3fd6673879f88ffff8c50dd5801d02b141cecc89))
* **crm:** scope audit-log-by-entity and normalize audit-log-admin to canonical helper ([ea45503](https://github.com/raid-guild/nexus-crm/commit/ea45503d576a6fc3181f742adaff58e58b735936))
* **crm:** scope contact reads by role and linked-account/opportunity access ([be7e186](https://github.com/raid-guild/nexus-crm/commit/be7e186236b2eef48b0915428cc75eca1c6f0667))
* **crm:** scope contract reads by role and linked-account access ([9b39448](https://github.com/raid-guild/nexus-crm/commit/9b39448178c3d6ed241aadf60894ea1fd9479a9f))
* **crm:** scope lead reads by role and linked-account access ([b5d088b](https://github.com/raid-guild/nexus-crm/commit/b5d088bbb63d69e5bc79fd62c32f37edf46eabbc))
* **crm:** scope opportunity reads by role; cache key respects user scope ([16c64fb](https://github.com/raid-guild/nexus-crm/commit/16c64fbfb063ae0ea41678fa059e74357e296561))
* **crm:** scope pgvector similarity results by user/manager/admin ([a1fb3a8](https://github.com/raid-guild/nexus-crm/commit/a1fb3a84a6aab9913929d61d1b5b1bc54420e276))
* **crm:** scope remaining opportunity read actions (by-account, by-contact, user-opps) ([e8bcfc9](https://github.com/raid-guild/nexus-crm/commit/e8bcfc91192d6929c046d91456393c1b82f0d6b7))
* **crm:** scope target and target-list reads by role ([9e326eb](https://github.com/raid-guild/nexus-crm/commit/9e326ebf35c6596af27779a3faa3b366856f9101))
* **crm:** switch CRM task document actions from broken axios calls to server actions ([efae73e](https://github.com/raid-guild/nexus-crm/commit/efae73e56c78d80fcfa7b1358a3bf78df32e8f43))
* **crm:** uncomment assigned_to_user in task document schema and remove ts-ignore ([46c2868](https://github.com/raid-guild/nexus-crm/commit/46c2868b34779d0924f578ae94dc3eb9cd303d7b))
* **crm:** wire CRM task documents to correct junction table + cleanup ([d4c503c](https://github.com/raid-guild/nexus-crm/commit/d4c503c598a6905b6be826d311beb3fac2218bfa))
* **crm:** wire task comments to correct FK column (assigned_crm_account_task) ([c60ea57](https://github.com/raid-guild/nexus-crm/commit/c60ea57dd2f45d800ead11466a32a5696d1c3754))
* default accounts prop to empty array in UpdateContractForm ([3e21eac](https://github.com/raid-guild/nexus-crm/commit/3e21eac5fba06aed2e718964995a0b06f7f3ef50))
* **deps:** patch 2 Dependabot vulnerabilities ([0e2746c](https://github.com/raid-guild/nexus-crm/commit/0e2746c2dd504e7e6a8c0d5e86ef9186e5b3c8f7))
* **deps:** patch Dependabot advisories via pnpm overrides ([42eba8e](https://github.com/raid-guild/nexus-crm/commit/42eba8e1b83cbe87b7f3a21f5d7df096f051e3d1))
* **deps:** patch Dependabot security advisories ([6002241](https://github.com/raid-guild/nexus-crm/commit/60022410b56eab12abd4b10615e1602ade8c159f))
* **deps:** patch Dependabot security advisories via pnpm overrides ([22b2ecf](https://github.com/raid-guild/nexus-crm/commit/22b2ecf2f09528a3219e740df36b7399ad967298))
* Docker e2e verification fixes ([e1ae699](https://github.com/raid-guild/nexus-crm/commit/e1ae699cf8ce0e767bacdd3034f14bf3b4bf304b))
* **docker:** make admin email configurable via ADMIN_EMAIL ([7427b0a](https://github.com/raid-guild/nexus-crm/commit/7427b0a3277b8fff83635cd1cf339eab92d442f1))
* **docker:** replace hardcoded credentials with env-driven placeholders ([255b11e](https://github.com/raid-guild/nexus-crm/commit/255b11e882d4e6bdcb4172f8905bd65556ee22df))
* **documents:** check upload response status in bulk upload modal ([d71dbf5](https://github.com/raid-guild/nexus-crm/commit/d71dbf52edb03144ba89f3b20e2dc5b4ef9deca1))
* **documents:** exclude pdf-parse and pdfjs-dist from Turbopack server bundle ([6ea7e4b](https://github.com/raid-guild/nexus-crm/commit/6ea7e4bec671046ea396e29930d132dcbe10d6f0))
* **documents:** filter bulk document operations by user scope (fail-closed) ([61132fe](https://github.com/raid-guild/nexus-crm/commit/61132fee767cffbd9b4d81d9dc7b052bb969d3c0))
* **documents:** replace next/image with img tag in DocumentViewModal ([3d2dafd](https://github.com/raid-guild/nexus-crm/commit/3d2dafdae168a2dccc6826d0b897a99351d0c901))
* **documents:** require ownership/account scope on document mutations ([5bb9035](https://github.com/raid-guild/nexus-crm/commit/5bb9035052326065cab5d5c56c57d959d60fce07))
* **documents:** scope document reads by role and linked-entity access ([220cf23](https://github.com/raid-guild/nexus-crm/commit/220cf231c5ddcda9905e556f92aefa4268d6015b))
* **documents:** use pdf-parse v2 class-based API for text extraction ([2825f90](https://github.com/raid-guild/nexus-crm/commit/2825f90efc4f2cf97c65901f7c1f7d9f4125db25))
* **documents:** use row.original directly instead of Zod parse in row actions ([20a6016](https://github.com/raid-guild/nexus-crm/commit/20a601665e0e7b24b6a9555eeb298460c4468505))
* guard FormSelect against undefined data and pass safe defaults ([91f1a45](https://github.com/raid-guild/nexus-crm/commit/91f1a457083794e2301dda4863376acbc37e7584))
* harden mcp lead import permissions ([64ebda0](https://github.com/raid-guild/nexus-crm/commit/64ebda06745dd922334b04ed4b1fcaf3e29154f1))
* honor admin scope in core mcp tools ([8d354ad](https://github.com/raid-guild/nexus-crm/commit/8d354adb58eada320159ec29a00f01b0622bf493))
* **invoices:** add PROFORMA to Zod invoice type enum ([18d6e40](https://github.com/raid-guild/nexus-crm/commit/18d6e40281ab8fb726f21c6c4b99ddb92ea79ff6))
* **invoices:** add supplier company details, PDF regeneration, admin route guard ([31e2b29](https://github.com/raid-guild/nexus-crm/commit/31e2b29c0d99d5a86429eeb5b03de38c45586cd2))
* **invoices:** consolidate Invoice_Currencies into shared Currency table ([43f3814](https://github.com/raid-guild/nexus-crm/commit/43f3814a57973d18a7d687ee153a7b108231f68b))
* **invoices:** consolidate Invoice_Currencies into shared Currency table ([2c6820d](https://github.com/raid-guild/nexus-crm/commit/2c6820d65e440906472f498b490f7c9fbdd73ea3))
* **invoices:** fix Set type annotation in permissions for strict tsc ([1132616](https://github.com/raid-guild/nexus-crm/commit/1132616272afd08368884862a2ef436bf24dfb12))
* **invoices:** hydration mismatches, decimal serialization, server action refactor ([75368f4](https://github.com/raid-guild/nexus-crm/commit/75368f409bf61792ca0997492448b30ab4a3cd36))
* **invoices:** redirect to /invoices after creating new invoice ([2dd2d5e](https://github.com/raid-guild/nexus-crm/commit/2dd2d5ecbee40f515a1f5d77153acffcea519600))
* **invoices:** redirect to invoice detail page after create/edit ([d58c35d](https://github.com/raid-guild/nexus-crm/commit/d58c35db10e4ab03d88aec9fa0be7297d915db58))
* **invoices:** remove unused imports and prefix unused params ([b3e4ccc](https://github.com/raid-guild/nexus-crm/commit/b3e4cccdabf580dedd4329afd3d2133eba38a436))
* **invoices:** remove unused React import from PDF template ([b851ece](https://github.com/raid-guild/nexus-crm/commit/b851ece3b534acfbc4d628ad6fb10227679ee7c1))
* **invoices:** replace Account select with searchable combobox ([08e9b3d](https://github.com/raid-guild/nexus-crm/commit/08e9b3d61f87113e6254fae2f48da15f6c2b42b5))
* **invoices:** require account read scope on get-invoices-by-accountId ([c8cbf66](https://github.com/raid-guild/nexus-crm/commit/c8cbf669e34e651eb65e9799f25491480eef52f2))
* **invoices:** require account write scope on create and on accountId reassignment ([f8282e5](https://github.com/raid-guild/nexus-crm/commit/f8282e5ec64f7f469502173d1d28af34b81f7bae))
* **invoices:** require read scope on source and write scope on accountId for duplicateInvoice ([eb792a7](https://github.com/raid-guild/nexus-crm/commit/eb792a76dd05dfba7bf9db855e27f6d293db5ce9))
* **invoices:** review fixes — balanceDue, FX outside tx, permissions, search column, email template ([dde9dfa](https://github.com/raid-guild/nexus-crm/commit/dde9dfaba15274c910329a71ad299585407c47f8))
* **invoices:** supplier company details, PDF regeneration, admin route guard ([4c45b8e](https://github.com/raid-guild/nexus-crm/commit/4c45b8e48ca60741c39d54ff2744a93242e1fabe))
* **line-items:** resolve build and type issues ([211ab7c](https://github.com/raid-guild/nexus-crm/commit/211ab7cf3cc496d08cc522c123323d9159426ecf))
* make FormSelect fully controlled to show defaultValue correctly ([0c926fc](https://github.com/raid-guild/nexus-crm/commit/0c926fc80a7851d780dd62611b3f63e3596d8d3f))
* **mcp:** add explicit ReportFilters type annotation to fix date type mismatch ([68414eb](https://github.com/raid-guild/nexus-crm/commit/68414eb4001ce2e0c35ea1e690db58c99960f510))
* **mcp:** fix campaign status filter collision and document unlink auth ([fc6f8a9](https://github.com/raid-guild/nexus-crm/commit/fc6f8a91a24098a21b1f1a9ad454fa7c14d6c0e4))
* **mcp:** fix remaining status:true in target lists, update soft-delete report ([3037daf](https://github.com/raid-guild/nexus-crm/commit/3037daf3dbc6a06360096f5934efab835a7401cb))
* **mcp:** prefix unused entity param in notFound helper ([e76305f](https://github.com/raid-guild/nexus-crm/commit/e76305f4ff439c27c76f1cfedff31ae1296ef405))
* **mcp:** remove isNotDeleted from opportunities (enum type mismatch), fix unused import in products ([3792d51](https://github.com/raid-guild/nexus-crm/commit/3792d515a0c05f97ea6f2c37749adcdafda8c3bc))
* **mcp:** set basePath so /api/mcp/{mcp,sse} actually route ([16fb5be](https://github.com/raid-guild/nexus-crm/commit/16fb5be137fb54b5de324f659dd8b48881004aad))
* **mcp:** set basePath so /api/mcp/{mcp,sse} actually route ([3c36be2](https://github.com/raid-guild/nexus-crm/commit/3c36be22658d27092606e32dea3d083fcc0b1bfd))
* merge dependabot vulnerability patches to main ([db6975a](https://github.com/raid-guild/nexus-crm/commit/db6975a43a23fded9abb53bbdf6e9c45aa6c165d))
* **migration:** rename and make idempotent for failed deploy recovery ([3393859](https://github.com/raid-guild/nexus-crm/commit/339385928a7005ff36fbc6a3df64eaf678fa600b))
* **migration:** scrub orphan creator FK refs before adding new FK constraint ([7fa5196](https://github.com/raid-guild/nexus-crm/commit/7fa5196b04d594386ce17bd23049207a556e581e))
* **migration:** seed currencies and clean data before VARCHAR cast ([6ca3dcc](https://github.com/raid-guild/nexus-crm/commit/6ca3dccf08960b8cf6c2d1e83c8a8a2632acb75a))
* order raidguild lead board statuses ([9d1f4b7](https://github.com/raid-guild/nexus-crm/commit/9d1f4b76a168789322623e7ef7d334917437f051))
* order raidguild lead board statuses ([d81543e](https://github.com/raid-guild/nexus-crm/commit/d81543e839411efb5b06ae7236957b1c5d2a64aa))
* patch 9 open dependabot vulnerabilities ([4c659fa](https://github.com/raid-guild/nexus-crm/commit/4c659fa89d180933ef6ddc4df161e12e025d35a4))
* patch 9 open dependabot vulnerabilities via pnpm overrides ([52d9b1f](https://github.com/raid-guild/nexus-crm/commit/52d9b1f23d93920e7014ada858163df13ce05c9e))
* **prisma:** add missing crm_Target_Contact migration ([7d76537](https://github.com/raid-guild/nexus-crm/commit/7d76537f9ae994430fd782b6c7a789eb4dac69a8))
* **prisma:** add missing migration for crm_Target_Contact table ([792b8c3](https://github.com/raid-guild/nexus-crm/commit/792b8c3ec24efeea963afdcbc71d4b2bf003bc72))
* **products:** require authentication on product read actions ([b2a860f](https://github.com/raid-guild/nexus-crm/commit/b2a860fcbff5cd84bbd73faf574c1f3079653ce2))
* **products:** require manager/admin role on product mutations ([61ed918](https://github.com/raid-guild/nexus-crm/commit/61ed918e65629661f9818ca2a4dcf6bc3f46a4cb))
* **products:** resolve audit log type errors and build issues ([784c444](https://github.com/raid-guild/nexus-crm/commit/784c444267f635594402f0528be6679e3e9d37d2))
* **projects:** require board write/read scope on board mutations ([522ca13](https://github.com/raid-guild/nexus-crm/commit/522ca1323f45b38f5c78fdd64116d5c6c8f07206))
* **projects:** require parent board write scope on section mutations ([65e208f](https://github.com/raid-guild/nexus-crm/commit/65e208fcff948eca80e3380fb599dc585f63b0e7))
* **projects:** scope project read actions by board access ([5ddaa97](https://github.com/raid-guild/nexus-crm/commit/5ddaa976f853b88b526c129e0787939aa4567a9b))
* **projects:** scope task mutations (board strict + assignee soft) ([27f0cf8](https://github.com/raid-guild/nexus-crm/commit/27f0cf8dfd7999599397d4f65a7f9d082900c848))
* refactor UpdateContractForm to self-fetch accounts and currencies ([23e1dab](https://github.com/raid-guild/nexus-crm/commit/23e1dabcc8185deb0f93c161d08aa6347a972636))
* remove any casts from serializeDecimalsList call sites ([10a5fe9](https://github.com/raid-guild/nexus-crm/commit/10a5fe9e8d0530d8993d080cf5b78555840b4709))
* remove conflicting defaultValue from controlled FormDatePicker input ([326f995](https://github.com/raid-guild/nexus-crm/commit/326f995857da1294a86ebb45420c9affc0d579b5))
* replace getEnabledCurrencies with proper server action ([614162d](https://github.com/raid-guild/nexus-crm/commit/614162d9a2a70941cf6d338e5ad6c85243d04caf))
* **reports:** gate users-directory report behind manager/admin ([20aeeaf](https://github.com/raid-guild/nexus-crm/commit/20aeeafec24b3d6f02ad3f69e1d0d2d68c88f4f8))
* **reports:** scope config and schedule reads/mutations by role and ownership ([932de36](https://github.com/raid-guild/nexus-crm/commit/932de36cd3dd84c20fae20d49f72badd76a970e0))
* **reports:** scope dashboard tasks count and unified search by role ([d17a880](https://github.com/raid-guild/nexus-crm/commit/d17a880eb6b8ac06097756d6006fcf11b44b1138))
* **reports:** scope scheduled-report data by schedule owner role ([7f7c7b6](https://github.com/raid-guild/nexus-crm/commit/7f7c7b63f1cf6fd550454b3040981f1bbef13b5d))
* require venice key for venice embeddings ([91601fb](https://github.com/raid-guild/nexus-crm/commit/91601fb70b83293576274cb781444df519b25127))
* resolve build errors - type casts and Inngest function signature ([0e3bf0f](https://github.com/raid-guild/nexus-crm/commit/0e3bf0f0ae5abed134d9319d460985c4dae7c782))
* resolve type issues in ECB sync function ([79b2663](https://github.com/raid-guild/nexus-crm/commit/79b266346fada836cb16c971224bc4a9ee502b9b))
* **schema:** add [@db](https://github.com/db).VarChar(3) to crm_Opportunities.currency field ([0ef0b8b](https://github.com/raid-guild/nexus-crm/commit/0ef0b8ba54251aed2900f8dc03558c315025869e))
* **security:** admin server action lockdown (Phase C) ([5a555fe](https://github.com/raid-guild/nexus-crm/commit/5a555febe929bb3d477704914756737a04f3d3fd))
* **security:** authz cleanup — drop is_admin, role enum (Phase F) ([c22bf83](https://github.com/raid-guild/nexus-crm/commit/c22bf837e83b10487641fcfc458629fa0fedf5d6))
* **security:** close enrichment BOLA/IDOR (Phase B1) ([726be4c](https://github.com/raid-guild/nexus-crm/commit/726be4cb48c60620a15c3a3a850e8bde379a6e54))
* **security:** close GHSA-mg5f-m89f-4gmc + permission-driven authz foundation ([e6987aa](https://github.com/raid-guild/nexus-crm/commit/e6987aa049dc6816a25c45436556960893c9c15d))
* **security:** close invoice IDOR (Phase B2) ([88d488b](https://github.com/raid-guild/nexus-crm/commit/88d488b939057f4769d22f6ce00442738d73792b))
* **security:** override defu&lt;=6.1.4 to 6.1.5 for prototype pollution CVE-2026-35209 ([507a866](https://github.com/raid-guild/nexus-crm/commit/507a866326a3920e04e38afefdc60bd4140f9de7))
* **security:** patch defu prototype pollution CVE-2026-35209 ([29d187d](https://github.com/raid-guild/nexus-crm/commit/29d187d2ab56fc7ec78913563864c2f7093c9c1b))
* **security:** scope campaigns + templates (Phase E2) ([99effa9](https://github.com/raid-guild/nexus-crm/commit/99effa90d2154a930933b58bf64105fd70e0f52a))
* **security:** scope CRM account reads by role (Phase D1) ([cbc3a30](https://github.com/raid-guild/nexus-crm/commit/cbc3a30a9b16ef3bd3e85ea7cc5bec234eba17f6))
* **security:** scope CRM accounts list by user authz read scope ([08c0ec7](https://github.com/raid-guild/nexus-crm/commit/08c0ec7c521d44c02e7978aaf1744d9229e049df))
* **security:** scope CRM accounts list by user authz read scope ([8e86e03](https://github.com/raid-guild/nexus-crm/commit/8e86e03894e4cb4b9d9c5d2265a915fd9ce775bb))
* **security:** scope CRM lead/contact/opportunity/contract reads by role (Phase D2) ([d795b00](https://github.com/raid-guild/nexus-crm/commit/d795b00f6558777f3019a830069561fccb4de4f5))
* **security:** scope documents + bulk ops (Phase E3) ([12ac3df](https://github.com/raid-guild/nexus-crm/commit/12ac3df7218d9512a5b6f0cf33cc750cc9ffe4d1))
* **security:** scope products + account-products + invoice list (Phase E1) ([4ecfc56](https://github.com/raid-guild/nexus-crm/commit/4ecfc565c7b40c2b038f418971fc292a2c596663))
* **security:** scope projects (boards/sections/tasks) (Phase E4) ([bc2a72a](https://github.com/raid-guild/nexus-crm/commit/bc2a72a23c6ae4895c7c9cdf74f45ccaeb915bf2))
* **security:** scope reports + dashboard + unified search by role (Phase B3) ([477dcf6](https://github.com/raid-guild/nexus-crm/commit/477dcf6b31db740bfb3e875f972c63ba2cd19bba))
* **security:** scope targets, activities, audit log, similarity (Phase D3) ([07a03f9](https://github.com/raid-guild/nexus-crm/commit/07a03f9f23b09b29994c1ccacd16fb3e520308c6))
* serialize Decimal fields before passing to client components ([ff68db2](https://github.com/raid-guild/nexus-crm/commit/ff68db28f40b01111cf56ccd4b6d822f3e69cf24))
* serialize Decimal fields in getAllCrmData for client components ([8451299](https://github.com/raid-guild/nexus-crm/commit/845129965078a0260c7cdc2a82a5a326104e38f4))
* serialize opportunity Decimal fields before passing to client component ([bed1604](https://github.com/raid-guild/nexus-crm/commit/bed16042018525b18b9e2c59ace7f74568e1e574))
* simplify dashboard cards ([d5ce700](https://github.com/raid-guild/nexus-crm/commit/d5ce700f18764a8e838a56ed36e534eff9fafe51))
* split currency lib into client-safe and server-only modules ([1a61be3](https://github.com/raid-guild/nexus-crm/commit/1a61be3b404ce10b85e50769b76dba1a8037477c))
* stabilize flaky e2e tests across CRM modules ([dbb88b6](https://github.com/raid-guild/nexus-crm/commit/dbb88b69fbe5dd013d7ea61d0da0c72036fbe3b2))
* **tests:** merge duplicate prismadb.documents mock keys after lowercase fix ([3446bc9](https://github.com/raid-guild/nexus-crm/commit/3446bc96e08d28457dee09d014297ef42370e91a))
* **tests:** update sales report tests for currency-aware aggregation ([c02d752](https://github.com/raid-guild/nexus-crm/commit/c02d7524a9636eb1ea2f2e81f27cb303833db81e))
* update @vercel/mcp-adapter to v1.0.0 and add to trusted builds ([e1583c2](https://github.com/raid-guild/nexus-crm/commit/e1583c2a7d87f6fc1790f0e0432d4812308988a7))
* wire currencies prop through opportunity and contract components ([dba0036](https://github.com/raid-guild/nexus-crm/commit/dba0036335819f598ec430f165cad8edf55b8213))
